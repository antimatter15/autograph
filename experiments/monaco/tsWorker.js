 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
import * as ts from 'monaco-editor/esm/vs/language/typescript/lib/typescriptServices.js';
import { lib_dts, lib_es6_dts } from 'monaco-editor/esm/vs/language/typescript/lib/lib.js';
...
var TypeScriptWorker = /** @class */ (function () {
    function TypeScriptWorker(ctx, createData) {
        ...
        console.log('TSWORKER', this)
    }
    // --- language service host ---------------

    

    // TypeScriptWorker.prototype.resolveModuleNames = function(moduleNames, containingFile){
    //     console.log('RESOLVING MODULE NAMES', moduleNames)
    ...
    TypeScriptWorker.prototype.fileExists = function(fileName){
