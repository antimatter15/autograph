...
export type Mutation = GQLType & {
    /** Deletes a Book. */
    deleteBook(args: { input: deleteBookInput }): deleteBookPayload | undefined
    /** Updates a Book. */
    updateBook(args: { input: updateBookInput }): updateBookPayload | undefined
    /** Creates a Book. */
    createBook(args: { input: createBookInput }): createBookPayload | undefined
    /** Deletes a Parchment. */
    /** @deprecated Create a Book instead */
    deleteParchment(args: { input: deleteParchmentInput }): deleteParchmentPayload | undefined
    /** Updates a Parchment. */
    /** @deprecated Create a Book instead */
    updateParchment(args: { input: updateParchmentInput }): updateParchmentPayload | undefined
    /** Creates a Parchment. */
    /** @deprecated Create a Book instead */
    createParchment(args: { input: createParchmentInput }): createParchmentPayload | undefined
    /** Deletes a Review. */
    deleteReview(args: { input: deleteReviewInput }): deleteReviewPayload | undefined
    /** Updates a Review. */
    updateReview(args: { input: updateReviewInput }): updateReviewPayload | undefined
    /** Creates a Review. */
    createReview(args: { input: createReviewInput }): createReviewPayload | undefined
}
