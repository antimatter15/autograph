                    ...
                    <tr>
                        <td>
                            <table border={0} cellPadding={0} cellSpacing={0} className="itemlist">
                                <tbody>
                                    {query.hn.topStories({ limit: 20 }).map((story, i) => (
                                        <React.Fragment key={story.id}>
                                            ...
                                            <tr>
                                                ...
                                                <td className="subtext">
                                                    ...
                                                    <span className="age">
                                                        <a href="item?id=20185182">{story.time}</a>
                                                    </span>{' '}
                                                    <span id="unv_20185182" /> |{' '}
                                                    <a href="flag?id=20185182&auth=3985c528dc060f679d6d0ba1fe1492b71558bc2e&goto=news">
                                                        flag
                                                    </a>{' '}
                                                    |{' '}
                                                    <a
                                                        href="hide?id=20185182&auth=3985c528dc060f679d6d0ba1fe1492b71558bc2e&goto=news"
                                                        onclick="return hidestory(event, this, 20185182)"
                                                    >
                                                        hide
                                                    </a>{' '}
                                                    |{' '}
