...
import { graphql, buildASTSchema, introspectionQuery, printSchema, buildClientSchema } from 'graphql'
...
console.log(printSchema(buildClientSchema(introspectionResult.data as any)))

async function parseGraphQL(schemaSource: string): Promise<any> {
...
test("Hello World", async () => {
    console.log(await parseGraphQL(`
