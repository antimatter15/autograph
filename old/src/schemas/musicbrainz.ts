export const url = "https://graphbrainz.herokuapp.com/"
...
the codes assigned by ISO to countries and subdivisions. */
    isoCodes(args: { standard?: string }): string[] | null
...
field. */
    ...
    artists(args: { after?: string, first?: number }): ArtistConnection | null

    /** A list of events linked to this entity. */
    events(args: { after?: string, first?: number }): EventConnection | null

    /** A list of labels linked to this entity. */
    labels(args: { after?: string, first?: number }): LabelConnection | null

    /** A list of places linked to this entity. */
    places(args: { after?: string, first?: number }): PlaceConnection | null

    /** A list of releases linked to this entity. */
    releases(args: { type?: ReleaseGroupType[], status?: ReleaseStatus[], after?: string, first?: number }): ReleaseConnection | null

    /** Relationships between this entity and other entitites. */
    relationships?: Relationships

    /** A list of collections containing this entity. */
    collections(args: { after?: string, first?: number }): CollectionConnection | null

    /** A list of tags linked to this entity. */
    tags(args: { after?: string, first?: number }): TagConnection | null
...
(ISNI) codes for the artist. */
    ...
    recordings(args: { after?: string, first?: number }): RecordingConnection | null

    /** A list of releases linked to this entity. */
    releases(args: { type?: ReleaseGroupType[], status?: ReleaseStatus[], after?: string, first?: number }): ReleaseConnection | null

    /** A list of release groups linked to this entity. */
    releaseGroups(args: { type?: ReleaseGroupType[], after?: string, first?: number }): ReleaseGroupConnection | null

    /** A list of works linked to this entity. */
    works(args: { after?: string, first?: number }): WorkConnection | null
...
is provided by the Last.fm extension. */
    ...
    spotify(args: { strategy?: SpotifyMatchStrategy[] }): SpotifyTrack | null
...
provided by the Last.fm extension. */
    ...
    spotify(args: { strategy?: SpotifyMatchStrategy[] }): SpotifyAlbum | null
...
export type Disc = {
    ...
    releases(args: { after?: string, first?: number }): ReleaseConnection | null
...
export type Relationships = {
    ...
    areas(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    artists(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    events(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    instruments(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    labels(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    places(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    recordings(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    releases(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    releaseGroups(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    series(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    urls(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null

    /** A list of relationships between these two entity types. */
    works(args: { direction?: string, type?: string, typeID?: any, after?: string, first?: number, before?: string, last?: number }): RelationshipConnection | null
...
field. */
    ...
    areas(args: { after?: string, first?: number }): AreaConnection | null
    ...
    instruments(args: { after?: string, first?: number }): InstrumentConnection | null
    ...
    series(args: { after?: string, first?: number }): SeriesConnection | null
...
the presence of an image. */
    front(args: { size?: CoverArtArchiveImageSize }): any | null
...
an image. */
    back(args: { size?: CoverArtArchiveImageSize }): any | null
...
export type FanArtImage = {
    ...
    url(args: { size?: FanArtImageSize }): any | null
...
export type TheAudioDBAlbum = {
    ...
    description(args: { lang?: string }): string | null
    ...
    discImage(args: { size?: TheAudioDBImageSize }): any | null

    /** An image of the spine of the album packaging. */
    spineImage(args: { size?: TheAudioDBImageSize }): any | null

    /** An image of the front of the album packaging. */
    frontImage(args: { size?: TheAudioDBImageSize }): any | null

    /** An image of the back of the album packaging. */
    backImage(args: { size?: TheAudioDBImageSize }): any | null
...
export type DiscogsMaster = {
    ...
    lowestPrice(args: { currency?: string }): number | null
...
export type LastFMAlbum = {
    ...
    image(args: { size?: LastFMImageSize }): any | null
...
languages. */
    description(args: { lang?: string }): LastFMWikiContent | null
...
not the MusicBrainz artist. */
    ...
    topTags(args: { first?: number, after?: string }): LastFMTagConnection | null
...
export type LastFMArtist = {
    ...
    similarArtists(args: { first?: number, after?: string }): LastFMArtistConnection | null

    /** A list of the artist’s most popular albums. */
    topAlbums(args: { first?: number, after?: string }): LastFMAlbumConnection | null

    /** A list of tags applied to the artist by users, ordered by popularity. */
    topTags(args: { first?: number, after?: string }): LastFMTagConnection | null

    /** A list of the artist’s most popular tracks. */
    topTracks(args: { first?: number, after?: string }): LastFMTrackConnection | null

    /** A biography of the artist, often available in several languages. */
    biography(args: { lang?: string }): LastFMWikiContent | null
...
not the MusicBrainz release. */
    ...
    similarTracks(args: { first?: number, after?: string }): LastFMTrackConnection | null
...
the number on the specified disc. */
    ...
    musicBrainz(args: { strategy?: SpotifyMatchStrategy[] }): Recording | null
...
export type TheAudioDBTrack = {
    ...
    thumbnail(args: { size?: TheAudioDBImageSize }): any | null
...
export type TheAudioDBMusicVideo = {
    ...
    screenshots(args: { size?: TheAudioDBImageSize }): any[]
...
export type TheAudioDBArtist = {
    ...
    /** A biography of the artist, often available in several languages. */
    biography(args: { lang?: string }): string | null
...
export type LastFMCountry = {
    ...
    topArtists(args: { first?: number, after?: string }): LastFMArtistConnection | null
...
export type BrowseQuery = {
    ...
    areas(args: { collection?: any, after?: string, first?: number }): AreaConnection | null

    /** Browse artist entities linked to the given arguments. */
    artists(args: { area?: any, collection?: any, recording?: any, release?: any, releaseGroup?: any, work?: any, after?: string, first?: number }): ArtistConnection | null

    /** Browse collection entities linked to the given arguments. */
    collections(args: { area?: any, artist?: any, editor?: string, event?: any, label?: any, place?: any, recording?: any, release?: any, releaseGroup?: any, work?: any, after?: string, first?: number }): CollectionConnection | null

    /** Browse event entities linked to the given arguments. */
    events(args: { area?: any, artist?: any, collection?: any, place?: any, after?: string, first?: number }): EventConnection | null

    /** Browse label entities linked to the given arguments. */
    labels(args: { area?: any, collection?: any, release?: any, after?: string, first?: number }): LabelConnection | null

    /** Browse place entities linked to the given arguments. */
    places(args: { area?: any, collection?: any, after?: string, first?: number }): PlaceConnection | null

    /** Browse recording entities linked to the given arguments. */
    recordings(args: { artist?: any, collection?: any, isrc?: any, release?: any, after?: string, first?: number }): RecordingConnection | null

    /** Browse release entities linked to the given arguments. */
    releases(args: { area?: any, artist?: any, collection?: any, discID?: any, label?: any, recording?: any, releaseGroup?: any, track?: any, trackArtist?: any, type?: ReleaseGroupType[], status?: ReleaseStatus[], after?: string, first?: number }): ReleaseConnection | null

    /** Browse release group entities linked to the given arguments. */
    releaseGroups(args: { artist?: any, collection?: any, release?: any, type?: ReleaseGroupType[], after?: string, first?: number }): ReleaseGroupConnection | null

    /** Browse work entities linked to the given arguments. */
    works(args: { artist?: any, collection?: any, iswc?: any, after?: string, first?: number }): WorkConnection | null
...
export type SearchQuery = {
    ...
    areas(args: { query: string, after?: string, first?: number }): AreaConnection | null

    /** Search for artist entities matching the given query. */
    artists(args: { query: string, after?: string, first?: number }): ArtistConnection | null

    /** Search for event entities matching the given query. */
    events(args: { query: string, after?: string, first?: number }): EventConnection | null

    /** Search for instrument entities matching the given query. */
    instruments(args: { query: string, after?: string, first?: number }): InstrumentConnection | null

    /** Search for label entities matching the given query. */
    labels(args: { query: string, after?: string, first?: number }): LabelConnection | null

    /** Search for place entities matching the given query. */
    places(args: { query: string, after?: string, first?: number }): PlaceConnection | null

    /** Search for recording entities matching the given query. */
    recordings(args: { query: string, after?: string, first?: number }): RecordingConnection | null

    /** Search for release entities matching the given query. */
    releases(args: { query: string, after?: string, first?: number }): ReleaseConnection | null

    /** Search for release group entities matching the given query. */
    releaseGroups(args: { query: string, after?: string, first?: number }): ReleaseGroupConnection | null

    /** Search for series entities matching the given query. */
    series(args: { query: string, after?: string, first?: number }): SeriesConnection | null

    /** Search for work entities matching the given query. */
    works(args: { query: string, after?: string, first?: number }): WorkConnection | null
...
given, retrieve the most popular artists in that country. */
    topArtists(args: { country?: string, first?: number, after?: string }): LastFMArtistConnection | null
...
given, retrieve the most popular tracks in that country. */
    topTracks(args: { country?: string, first?: number, after?: string }): LastFMTrackConnection | null

}

export type SpotifyQuery = {
    /** Track recommendations based on seed entities and various parameters. */
    recommendations(args: { seedArtists?: string[], seedGenres?: string[], seedTracks?: string[], limit?: number }): SpotifyRecommendations
