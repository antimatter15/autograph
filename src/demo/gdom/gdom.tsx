    ...
    <tbody><tr><td bgcolor="#ff6600"><table border={0} cellPadding={0} cellSpacing={0} width="100%" style={{ padding: '2px' }}><tbody><tr><td style={{ width: '18px', paddingRight: '4px' }}><a href="https://news.ycombinator.com"><img src="https://news.ycombinator.com/y18.gif" width={18} height={18} style={{ border: '1px white solid' }} /></a></td>
        ...
        <tr id="pagespace" title style={{ height: '10px' }} /><tr><td><table border={0} cellPadding={0} cellSpacing={0} className="itemlist">
            <tbody>
                ...
                {
                    page.query({selector:"tr.athing"})!.map((story, i) => <React.Fragment key={i}>
                        <tr className="athing">
                            <td align="right" valign="top" className="title"><span className="rank">{
                             ...
                             <td valign="top" className="votelinks"><center><a id="up_20185182"  href="#">
                                 ...
                                 <td className="title"><a href={
                                     story.attr({selector:"td.title a", name:"href" })
                                 } className="storylink">{
                                     story.text({selector:"td.title a"})
                                 }</a>
                                 <span className="sitebit comhead">&nbsp;({
                                     story.text({selector:"span.comhead a"})
                                 })</span></td></tr><tr><td colSpan={2} /><td className="subtext">
                                <span className="score" id="score_20185182">{
                                    story.next({})!.text({selector:"span.score"})
                                } points</span> by <a href="user?id=whiskers" className="hnuser">{
                                    story.next({})!.text({selector:"a:eq(0)"})
                                }</a> <span className="age"><a href="item?id=20185182"></a></span> | {' '}
                                <a href="item?id=20185182">{story.next({})!.text({selector:"a:eq(3)"})}</a>            </td></tr>
